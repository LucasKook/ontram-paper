...
for (split in 0:19) {
  ...
  compile(mod, optimizer = "adam", loss = "categorical_crossentropy",
  ...
  ce_train <- append(ce_train, eval_train[["loss"]])
  ce_test <- append(ce_test, eval_test[["loss"]])
